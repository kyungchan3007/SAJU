...
- 키워드: `Mystic`, `Premium`, `Soft Glow`, `Night Sky`, `Korean fortune-telling mood`
- 시각 톤:
  - 어두운 우주 배경 + 핑크/퍼플/블루 계열 글로우 포인트
  - 라운드가 큰 카드(`2rem`) + 유리질감(`backdrop-blur`) + 은은한 그림자
  - 텍스트는 과장보다 "읽기 쉬운 서사형"을 우선
- UX 톤:
  - 첫 화면은 감성/몰입
...
[프로젝트 톤]
- Mystic, Premium, Soft Glow, Night Sky
- 감성은 랜딩에서 강하게, 기능 화면에서는 명확성과 신뢰를 우선
