    ...
    return (
      <div className="relative">
        <select
          ref={ref}
          className={cn(
            "h-[46px] w-full appearance-none rounded-xl border bg-white px-3 pr-8 text-[13px] text-content-primary outline-none transition-colors focus:shadow-[0_0_0_3px_rgba(89,86,233,0.10)] disabled:cursor-not-allowed disabled:opacity-50",
        ...
        <span className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[11px] text-content-subtle">
          ▾
        </span>
      </div>
    );
