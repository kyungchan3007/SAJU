  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex items-center gap-2">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="#5956E9" stroke="none">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
          </svg>
        </div>
        <span className="text-[15px] font-extrabold text-[#111827]">궁합 대상</span>
      </div>
      ...
      <div className="relative grid grid-cols-2 gap-3">
        ...
        <div className="flex flex-col items-center gap-2.5">
          <div className="relative h-[350px] w-full overflow-hidden rounded-[18px] shadow-md">
            <Image
          ...
          {myDesc && (
            <p className="text-center text-[11px] leading-[1.6] text-[#6B7280]">{myDesc}</p>
          )}
        </div>

        {/* VS 배지 */}
        <div className="absolute left-1/2 top-[175px] z-10 flex h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-md"
        ...
        <div className="flex flex-col items-center gap-2.5">
          <div className="relative h-[350px] w-full overflow-hidden rounded-[18px] shadow-md">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
            <div className="absolute bottom-2 left-3">
              <p className="text-[13px] font-black text-white">{partner.name}</p>
            </div>
          </div>
          {partnerDesc && (
            <p className="text-center text-[11px] leading-[1.6] text-[#6B7280]">{partnerDesc}</p>
          )}
        </div>
      </div>
    </div>
