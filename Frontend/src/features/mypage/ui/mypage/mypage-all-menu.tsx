      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-5">
        {ALL_MENU_ITEMS.map((item) => (
          <a
            key={item.label}
            href={item.href}
            className="group flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all hover:border-[#5956E9]/30"
          >
            <div
            ...
            <span className="mb-1 text-sm font-bold text-slate-800">{item.label}</span>
