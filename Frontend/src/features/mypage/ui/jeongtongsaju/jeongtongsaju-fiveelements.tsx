  ...
  return (
    <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-[0_2px_16px_rgba(0,0,0,0.08)]">
      ...
      {(yongshinPrimary || yongshinSecondary) && (
        <div className="mt-5 rounded-2xl bg-[#F9F8FF] p-4 border border-[#E0DAFF]">
          <h4 className="mb-1.5 text-[13px] font-bold text-[#5956E9]">오행 해석</h4>
            ...
            {yongshinPrimary && (
              <div className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-[#C4BAFF] bg-white px-3 py-2">
                ...
                <span className="text-[14px] font-bold text-gray-900">
                  {yongshinPrimary}({yongshinPrimary === "금" ? "金" : yongshinPrimary === "목" ? "木" : yongshinPrimary === "토" ? "土" : yongshinPrimary === "화" ? "火" : "水"})
                </span>
              </div>
            )}
            {yongshinSecondary && (
              <div className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-[#C4BAFF] bg-white px-3 py-2">
                ...
                <span className="text-[14px] font-bold text-gray-900">
                  {yongshinSecondary}({yongshinSecondary === "금" ? "金" : yongshinSecondary === "목" ? "木" : yongshinSecondary === "토" ? "土" : yongshinSecondary === "화" ? "火" : "水"})
                </span>
              </div>
            )}
          </div>
