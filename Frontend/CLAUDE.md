...
- `/`(HOME) UX/UI 작업: `HOME_UX_UI_GUID.md`
...
- 허용된 `.md`만 읽는다(allow-list):
  ...
  - `HOME_UX_UI_GUID.md` (`/` HOME UX/UI 작업 시)
...
허용된 문서는 CLAUDE.md, PROJECT_ARCHITECTURE_CARD.md, src/domain/saju/saju-card.md, HOME_UX_UI_GUID.md 입니다.
